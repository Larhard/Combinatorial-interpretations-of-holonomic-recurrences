...
Next, in Section~\ref{sec:known_results}, we present known results, i.e.~binary trees, unary-binary trees and Schröder trees. They demonstrate combinatorial interpretations that reflect different approaches.
