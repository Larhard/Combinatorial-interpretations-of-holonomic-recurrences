...
\begin{definition}
    Section \(T_{i,j}\) is defined as subset of \(L_i\) adding specific set of nodes. We assign \(j\) according to the lexicographical order of lexicographically sorted node types that need 
\end{definition}
