...
\section{Overview}%
Initial inspiration for the thesis came from \textit{A natural counting of lambda terms}\cite{zigzag} publication, which shows bijection between seemingly different tree structures, which are lambda trees, black-white trees nad zigzag free trees.
\todo{Finish the overview section}
